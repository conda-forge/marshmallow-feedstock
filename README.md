...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/marshmallow-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/marshmallow-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add marshmallow
# for installing globally
pixi global install marshmallow
```
...
It is possible to list all of the versions of `marshmallow` available on your platform:
...
```
pixi search marshmallow --channel conda-forge
```
